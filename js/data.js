...
const SIGHTINGS = [
  ...
  { wave: 1, releaseDay: 3, date: '2024-10-08', time: '03:53:08', location: 'SHI-11 / TAIPEI-TW', observer: 'R-14', type: 'Type 4', description: 'Type 4 inflation event near arguing couple. Approx 2x volume. Deflation took 45 sec.' },
  { wave: 1, releaseDay: 5, date: '2024-10-18', time: '23:12:09', location: 'SHI-05 / TAIPEI-TW', observer: 'R-07', type: 'Type 2', description: 'Specimen "MrQ" (designation per field journal) attempted to intimidate a street cat. Arms raised, tongue extended, hips shaking. Cat unimpressed. Specimen escalated — performed headbutt charge at trash can. Got dizzy. Flexed proudly.' },
  { wave: 1, releaseDay: 6, date: '2024-10-25', time: '01:45:33', location: 'BER-03 / BERLIN-DE', observer: 'R-22', type: 'Type 3', description: 'Type 3 detected near subway busker playing guitar. Began involuntary rhythm sway. Full-body movement escalated within 30 sec. Tail swept umbrella stand into the street. Busker incorporated chaos into performance. Crowd doubled.' },
  { wave: 1, releaseDay: 8, date: '2024-11-28', time: '01:22:14', location: 'NYC-07 / NEW YORK-US', observer: 'R-31', type: 'Type 1', description: 'Specimen "Fugu" — sprint-to-tenderness cycle confirmed. Explosive sprint down platform, sudden freeze at sight of sleeping kitten near ventilation grate. Full tender pause: 62 sec.' },
  { wave: 1, releaseDay: 10, date: '2024-12-03', time: '23:09:37', location: 'PAR-12 / PARIS-FR', observer: 'R-18', type: 'Type 3', description: 'Montmartre sighting. "Groovix" detected near accordion player. Rhythm drift escalated to full-body groove. Tail whipped through three easels. Artists seemed delighted rather than upset.' },
  ...
  { wave: 2, releaseDay: 13, date: '2025-02-03', time: '02:58:16', location: 'NYC-07 / NEW YORK-US', observer: 'R-31', type: null, description: 'Four-type co-occurrence — first documented outside Taipei. All four types within 200m radius. Duration: 4 min 22 sec. All specimens moved in same direction before dispersing.' },
...
const MAP_SIGHTINGS = [
  ...
  { id: 20, wave: 1, releaseDay: 1, replacedByWave: 2, city: 'Taipei', location: 'Shilin Night Market', left: '77%', top: '42%', description: 'Type 1 sprint-freeze near market entrance. 47-second pause at a flower stall. First entry in this log.' },
  ...
  { id: 12, wave: 3, releaseDay: 0, city: 'Cape Town', location: 'V&A Waterfront', left: '52%', top: '63%', description: 'Type 1 — first Southern Hemisphere sprint observed. Oriented toward Taipei.' },
...
const SHILIN_DOTS = [
  ...
  { id: 's0', wave: 4, releaseDay: 0, location: 'Shilin Night Market — Main Gate', left: '40.1%', top: '26.3%', description: 'Primary convergence node. All four types documented. Highest frequency of multi-type co-occurrence events.' },
  ...
  { id: 'source-revealed', wave: 5, releaseDay: 0, location: 'SRC-01 — Shilin Night Market — [GALLERY NAME TBD]', left: '41.0%', top: '28.2%', description: 'Coordinates resolved. The signal was stationary all along. Street-level exhibition space. The door is open during gallery hours.', isSource: true },
];
...
const JOURNAL_PAGES = [
  ...
  { wave: 2, releaseDay: 3, page: 6, date: 'November 5', text: 'Spoke to M. about the energy pattern. She was not surprised. She said: Of course they are losing it. They carry what we cannot hold.<br><br>M. does not think like a researcher. She perceives something I cannot measure. I am not sure I trust her methods. I am sure she sees something I do not.<br><br>(I recorded the call. She knows. She said the tape would not matter. I do not know what she meant by that.)', marginNote: 'The comment threads have picked the names up. I did not put them there.', contentType: 'text' },
...
const PROFILES = [
  ...
  { name: 'MrQ', type: 'Type 2', classification: 'Explosive Cheerleader', firstSighting: 'September 10, 2024', height: '20cm', behavior: 'Theatrical fake intimidation. Everything is a performance.', dangerLevel: 'Minimal', notes: 'Believes he is terrifying. Has never terrified anyone.' },
